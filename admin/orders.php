            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="gradient-card from-green-500 to-green-600 rounded-2xl p-6 text-white hover-lift">
                        ...
                        <div class="text-3xl font-bold mb-2">Rs<?= number_format($stats['total_revenue'], 0) ?></div>
                    ...
                    <div class="gradient-card from-brand-yellow to-brand-amber rounded-2xl p-6 text-white hover-lift">
                        ...
                        <div class="text-3xl font-bold mb-2">Rs<?= number_format($stats['avg_order_value'], 2) ?></div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php foreach ($orders as $order): ?>
                                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-bold text-gray-900">Rs<?= number_format($order['total_amount'], 2) ?></div>
                                        </td>
