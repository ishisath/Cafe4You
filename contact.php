        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="contact.php" class="text-brand-orange font-semibold relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-brand-orange">Contact</a>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 pt-6">
                        <a href="tel:+15551234567" class="flex items-center space-x-3 p-4 bg-white/10 backdrop-blur-sm rounded-xl hover:bg-white/20 transition-all duration-300">
                            ...
                            <div>
                                <div class="text-sm font-semibold">Call Us</div>
                                <div class="text-xs opacity-80">Quick Response</div>
                            </div>
                        </a>
                        
                        <a href="mailto:info@cafeforyou.com" class="flex items-center space-x-3 p-4 bg-white/10 backdrop-blur-sm rounded-xl hover:bg-white/20 transition-all duration-300">
                            <div class="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <div class="text-xs opacity-80">24hr Response</div>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="relative">
                    <div class="bg-white/10 backdrop-blur-sm rounded-3xl p-6 border border-white/20">
                        <div class="relative overflow-hidden rounded-2xl">
                            <img src="https://images.unsplash.com/photo-1577219491135-ce391730fb2c?w=600&h=400&fit=crop&crop=faces" 
                                 alt="Friendly Restaurant Staff" 
                                 class="w-full h-80 object-cover"
                                 loading="lazy"
                                 onerror="this.onerror=null; this.src='https://images.unsplash.com/photo-1600298881974-6be191ceeda1?w=600&h=400&fit=crop&crop=center';">
                            
                            <!-- Staff badge overlay -->
                            <div class="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 flex items-center space-x-2">
                                <span class="text-2xl">👨‍🍳</span>
                                <span class="text-sm font-semibold text-gray-800">Friendly Staff</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="absolute -top-4 -right-4 bg-white rounded-2xl p-3 shadow-xl">
                        <div class="text-center">
                            <div class="text-lg font-bold text-brand-orange">5.0★</div>
                            <div class="text-xs text-gray-600">Service</div>
                        </div>
                    </div>

                    <!-- Fallback content if image fails -->
                    <div class="absolute inset-0 bg-gradient-to-br from-brand-orange/20 to-red-500/20 rounded-3xl flex items-center justify-center opacity-0 transition-opacity duration-300" id="image-fallback">
                        <div class="text-center text-white">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Our Friendly Team</h3>
                ...
                <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+15551234567" class="text-brand-orange font-medium text-sm hover:underline">(555) 123-4567</a>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:info@cafeforyou.com" class="text-brand-orange font-medium text-sm hover:underline">info@cafeforyou.com</a>
                                </div>
                            </div>
                    ...
                    <div class="bg-gradient-to-br from-orange-50 to-red-50 rounded-3xl p-6 border border-orange-100">
                        ...
                        <div class="flex flex-col space-y-3">
                            <a href="tel:+15551234567" class="bg-brand-orange text-white px-4 py-3 rounded-xl text-sm font-semibold hover:bg-red-500 transition-all duration-300 text-center flex items-center justify-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                </svg>
                                <span>Call Now</span>
                            </a>
                            <a href="reservations.php" class="bg-white text-brand-orange border-2 border-brand-orange px-4 py-3 rounded-xl text-sm font-semibold hover:bg-orange-50 transition-all duration-300 text-center flex items-center justify-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-20 bg-brand-cream">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12">
                <h2 class="text-4xl font-bold text-gray-800 mb-4">Find <span class="text-brand-orange">Our Location</span></h2>
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-3xl card-shadow overflow-hidden hover-lift">
                        <div class="h-96 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center relative">
                            <div class="text-center">
                                ...
                                <p class="text-gray-600">Map integration would appear here</p>
                            </div>
                            
                            <!-- Location pin overlay -->
                            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                                <div class="w-8 h-8 bg-brand-orange rounded-full border-4 border-white shadow-lg animate-bounce"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-3xl card-shadow p-6 hover-lift">
                        ...
                        <div class="mt-4">
                            <a href="https://maps.google.com" target="_blank" class="bg-brand-orange text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-red-500 transition-all duration-300 inline-flex items-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
